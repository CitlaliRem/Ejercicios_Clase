	...
	glPushMatrix();
		...
		glPushMatrix();		
			...
			glPushMatrix();
				...
				glPushMatrix();//llanta delantera izquierda
					glTranslatef(6,-1,7.5);
					glRotatef(180, 0, 1, 0);
					glRotatef(movllantas, 1, 0, 0);
					llanta.GLrender(NULL,_SHADED,1.0);
				glPopMatrix();

				glPushMatrix();//llanta delantera derecha
					glTranslatef(-6, -1, 7.5);
					glRotatef(movllantas, 1, 0, 0 );
					llanta.GLrender(NULL, _SHADED, 1.0);
				glPopMatrix();

				glPushMatrix();//llanta trasera izquierda
				...
				glPushMatrix();//llanta trasera derecha
					glTranslatef(-6, -1, -9.5);
					glRotatef(movllantas, 1, 0, 0);
					llanta.GLrender(NULL, _SHADED, 1.0);
				glPopMatrix();
...
void keyboard ( unsigned char key, int x, int y )  // Create Keyboard Function
{
	switch ( key ) {
		...
		case 'o':
		case 'O':		//Poner algo en movimiento
