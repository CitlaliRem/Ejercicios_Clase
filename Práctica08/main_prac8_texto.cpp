...
void prisma(GLuint textura1, GLuint textura2)  //Funcion creacion prisma
{
	...
	glTexCoord2f(0.5, 0.33f); glVertex3fv(vertice[0]);
	glTexCoord2f(0.5, 0.66f); glVertex3fv(vertice[4]);
	glTexCoord2f(0.25, 0.66f); glVertex3fv(vertice[7]);
	glTexCoord2f(0.25f, 0.33); glVertex3fv(vertice[1]);
	glEnd();

	glBegin(GL_POLYGON);	//Right
	glNormal3f(1.0f, 0.0f, 0.0f);
	glTexCoord2f(0.5f, 0.3333f); glVertex3fv(vertice[0]);
	glTexCoord2f(0.75f, 0.3333f); glVertex3fv(vertice[3]);
	glTexCoord2f(0.75f, 0.6666f); glVertex3fv(vertice[5]);
	glTexCoord2f(0.5f, 0.6666f); glVertex3fv(vertice[4]);
	glEnd();

	glBegin(GL_POLYGON);	//Back
	glNormal3f(0.0f, 0.0f, -1.0f);
	glTexCoord2f(0.75f, 0.3333f); glVertex3fv(vertice[6]);
	glTexCoord2f(1.0f, 0.3333f); glVertex3fv(vertice[5]);
	glTexCoord2f(1.0f, 0.6666f); glVertex3fv(vertice[3]);
	glTexCoord2f(0.75f, 0.6666f); glVertex3fv(vertice[2]);
	glEnd();

	glBegin(GL_POLYGON);  //Left
	glNormal3f(-1.0f, 0.0f, 0.0f);
	glTexCoord2f(0.0f, 0.3333f); glVertex3fv(vertice[1]);
	glTexCoord2f(0.25f, 0.3333f); glVertex3fv(vertice[7]);
	glTexCoord2f(0.25f, 0.6666f); glVertex3fv(vertice[6]);
	glTexCoord2f(0.0f, 0.6666f); glVertex3fv(vertice[2]);
	glEnd();
	...
	glTexCoord2f(0.5f, 0.3333f); glVertex3fv(vertice[2]);
	glTexCoord2f(0.25f, 0.3333f); glVertex3fv(vertice[3]);
	glEnd();

	glBegin(GL_POLYGON);  //Top
	glNormal3f(0.0f, 1.0f, 0.0f);
	glTexCoord2f(0.5, 0.6666f); glVertex3fv(vertice[4]);
	glTexCoord2f(0.5, 1.0f); glVertex3fv(vertice[5]);
	glTexCoord2f(0.25, 1.0f); glVertex3fv(vertice[6]);
	glTexCoord2f(0.25f, 0.6666f); glVertex3fv(vertice[7]);
	glEnd();
}
...
void display(void)   // Creamos la funcion donde se dibuja
{
	...
	prisma(t_Cube.GLindex, t_metal01.GLindex);
	glPopMatrix();
