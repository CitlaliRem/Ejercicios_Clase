...
//****  Acercar: teclas 'W' 'w'      *************************//
//****  Alejar: teclas 'S' 's'       *************************//
//****  Mover en x:  teclas 'G' 'g'  *************************//
//****  Mover en y:  teclas 'H' 'h'  *************************//
//****  Mover en z:  teclas 'J' 'j'  *************************//
//****  Mover Rodilla Izq Enfrente: tecla 'b'  **************//
//****  Mover Rodilla Izq Atrás: tecla 'B'  **************//
//****  Mover Rodilla Der Enfrente: tecla 'V'  **************//
//****  Mover Rodilla Der Atrás: tecla 'v'  **************//
//****  Mover Brazo Izq Enfrente: tecla 'n'  **************//
//****  Mover Brazo Izq Atrás: tecla 'N'  **************//
//****  Mover Brazo Der Enfrente: tecla 'm'  **************//
//****  Mover Brazo Der Atrás: tecla 'M'  **************//
//****  Mover Muñeca Izq Enfrente: tecla 'x'  **************//
//****  Mover Muñeca Izq Atrás: tecla 'X'  **************//
//****  Mover Muñeca Der Enfrente: tecla 'c'  **************//
//****  Mover Muñeca Der Atrás: tecla 'C'  **************//
//************************************************************//
...
float posX =0, posY = 2.5, posZ =-3.5, rotRodIzq = 0, rotRodDer = 0, rotBrazo1=0, rotBrazo2 = 0, rotMuñeca1, rotMuñeca2;
float giroMonito = 0;
...
void saveFrame ( void )
{
	...
	KeyFrame[FrameIndex].rotBrazo1 = rotBrazo1;
	KeyFrame[FrameIndex].rotBrazo2 = rotBrazo2;
	KeyFrame[FrameIndex].rotMuñeca1 = rotMuñeca1;
	KeyFrame[FrameIndex].rotMuñeca2 = rotMuñeca2;
...
void resetElements( void )
{
	...
	rotMuñeca1 = KeyFrame[0].rotMuñeca1;
	rotMuñeca2 = KeyFrame[0].rotMuñeca2;
...
void interpolation ( void )
{
	...
	KeyFrame[playIndex].rotInc = (KeyFrame[playIndex + 1].rotRodDer - KeyFrame[playIndex].rotRodDer) / i_max_steps;
	KeyFrame[playIndex].rotInc = (KeyFrame[playIndex + 1].rotBrazo1 - KeyFrame[playIndex].rotBrazo1) / i_max_steps;
	KeyFrame[playIndex].rotInc = (KeyFrame[playIndex + 1].rotBrazo2 - KeyFrame[playIndex].rotBrazo2) / i_max_steps;
	KeyFrame[playIndex].rotInc = (KeyFrame[playIndex + 1].rotMuñeca1 - KeyFrame[playIndex].rotMuñeca1) / i_max_steps;
	KeyFrame[playIndex].rotInc = (KeyFrame[playIndex + 1].rotMuñeca2 - KeyFrame[playIndex].rotMuñeca2) / i_max_steps;
...
void monito()
{
	...
	glPushMatrix();//Pecho
		...
		glPushMatrix(); //Brazo derecho-->
			glRotatef(15 + rotBrazo1, 0, 1, 0);
			glTranslatef(1.25, 0.65, 0);
			fig7.esfera(0.5, 12, 12, 0);
			glPushMatrix();
				glTranslatef(0.25, 0, 0);
				glRotatef(-45, 0, 1, 0);
				glRotatef(15 + rotMuñeca1, 0, 0, 1);
...
void InitGL ( GLvoid )     // Inicializamos parametros
{
	...
	for(int i=0; i<MAX_FRAMES; i++)
	{
		...
		KeyFrame[i].rotBrazo1 = 0;
		KeyFrame[i].rotBrazo2 = 0;
		KeyFrame[i].rotMuñeca1 = 0;
		KeyFrame[i].rotMuñeca2 = 0;
		KeyFrame[i].rotInc =0;
...
void animacion()
{
	...
	{		
		...
		else
		{
			...
			rotRodDer+=KeyFrame[playIndex].rotInc;
			rotBrazo1+=KeyFrame[playIndex].rotInc;
			rotBrazo2+=KeyFrame[playIndex].rotInc;
			rotMuñeca1+=KeyFrame[playIndex].rotInc;
			rotMuñeca2+=KeyFrame[playIndex].rotInc;
